...
<body>
	<div class="container">
		<div class="content-container">
			<!-- Company Logo -->
			<div class="row company-logo-container">
				<div class="company-logo centerred">
					<img src="https://upload.wikimedia.org/wikipedia/commons/8/88/Migme_logo.png"/>
				</div>
			</div>

			<!-- Invitation Text -->
			<div class="row invitation-text-container">
				<div class="invitation-text">
					<p>
						<strong>Chi-Heng Huang</strong> wants to share photos, music, games and hottest updates with you.
					</p>
				</div>
			</div>
			...
			<div class="row">
				<div class="user-avatar">
					<div class="user-avatar-upper"></div>
					<div class="user-avatar-bottom"></div>
					<div class="user-image centerred circular-lg">
			...
			<div class="row profile-container">
				...
				<div class="row user-info-list">
				 ...
				 <!-- List of Posts -->
				 <div class="row posts-container centre">
					   <!-- Loop Posts From here -->
					 	<div class="post">
					    	<div class="row">
					         <!-- User Photo -->
								<div class="post-author-avatar float-left">
									<a href="http://mig.me/u/cutmemey" class="profile-hovercard" data-username="cutmemey" data-hasqtip="268" oldtitle="cutmemey" title="" aria-describedby="qtip-268">
										<img src="http://img.mig.me/dp/cutmemey?w=36&amp;h=36&amp;a=1&amp;c=1" width="36" height="36" class="circular-sm">
									</a>
					         	</div>

							 	<div class="post-author">
								 	<div class="post-author-name no-padding-left">
								 	...
								 	<div class="post-time font-size12 no-padding-left">
					       ...
					       <!-- User Name and Badges -->
							<div class="post-author-status no-padding-left">
					 ...
					 <div class="row">
						 <div class="post-image">
							 <a href="http://b-img.cdn.mig.me/i/8035/db3e4c2cce2395a89b062e0c0bd0e29f9b6c/1444291907398" class="fancybox" rel="homefeed" title="jeffreykumar: There&amp;#039;s a wall in #migme office where we hang the multis/bots we kill...  #justkidding #halloween ">
								 <img class="post-image-img" src="http://b-img.cdn.mig.me/i/cd28/77028c846e3bcabbde71301da05098ebc213/1445567554458">
							 </a>
						 </div>
					 </div>
				  </div><!-- End of Post -->
				  ...
				  <div class="post">
				   ...
				   <div class="row">
					   <div class="post-text">
						 <p>Breast Cancer is freakin terrible.<p>
					   </div>
				   </div>
				  ...
				  <div class="row">
					  <div class="post-image">
						  <a href="http://b-img.cdn.mig.me/i/8035/db3e4c2cce2395a89b062e0c0bd0e29f9b6c/1444291907398" class="fancybox" rel="homefeed" title="jeffreykumar: There&amp;#039;s a wall in #migme office where we hang the multis/bots we kill...  #justkidding #halloween ">
							  <img class="post-image-img" src="http://b-img.cdn.mig.me/i/5ebc/c847adeac308e01b8d9a60d0fb9fe54d6c39/1445590637520">
						  </a>
					  </div>
				  </div>
			   </div><!-- End of Post -->
