		...
		<div class="container">
			<div class="row form-container">
				<div class="form-title">					
					<strong>Email</strong><div class="red-exclamation"></div>
					<p>Set up or change your email address</p>
				</div>	
				<form class="form-horizontal profile-setting-form">
					...
					<p class="remark">We’ll send a verification email to this address. Please respond within 48 hours.</p>
